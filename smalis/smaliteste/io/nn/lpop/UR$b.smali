...
.method constructor <init>(C[F)V
    ...
    iput-char p1, p0, Lio/nn/lpop/UR$b;->a:C

    iput-object p2, p0, Lio/nn/lpop/UR$b;->b:[F

    return-void
.end method

.method constructor <init>(Lio/nn/lpop/UR$b;)V
    .registers 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-char v0, p1, Lio/nn/lpop/UR$b;->a:C

    iput-char v0, p0, Lio/nn/lpop/UR$b;->a:C

    iget-object p1, p1, Lio/nn/lpop/UR$b;->b:[F

    const/4 v0, 0x0

    array-length v1, p1

    invoke-static {p1, v0, v1}, Lio/nn/lpop/UR;->c([FII)[F

    move-result-object p1

    iput-object p1, p0, Lio/nn/lpop/UR$b;->b:[F

    return-void
.end method

.method static synthetic a(Lio/nn/lpop/UR$b;)C
    .registers 1

    iget-char p0, p0, Lio/nn/lpop/UR$b;->a:C

    return p0
.end method

.method static synthetic b(Lio/nn/lpop/UR$b;C)C
    .registers 2
...
.method static synthetic c(Lio/nn/lpop/UR$b;)[F
    .registers 1

    iget-object p0, p0, Lio/nn/lpop/UR$b;->b:[F
...
.method static synthetic d(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lio/nn/lpop/UR$b;->e(Landroid/graphics/Path;[FCC[F)V
...
.method private static e(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_2f0
    ...
    if-eq v11, v1, :cond_270

    const/16 v5, 0x48

    if-eq v11, v5, :cond_264

    const/16 v5, 0x51

    if-eq v11, v5, :cond_245

    const/16 v6, 0x56

    if-eq v11, v6, :cond_239

    const/16 v6, 0x61

    if-eq v11, v6, :cond_1ec

    const/16 v6, 0x63

    if-eq v11, v6, :cond_1c4

    const/16 v15, 0x68

    if-eq v11, v15, :cond_1b9

    const/16 v15, 0x71

    if-eq v11, v15, :cond_19b

    const/16 v14, 0x76

    if-eq v11, v14, :cond_191
    ...
    invoke-static/range {v0 .. v9}, Lio/nn/lpop/UR$b;->g(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method private static g(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v6 .. v24}, Lio/nn/lpop/UR$b;->f(Landroid/graphics/Path;DDDDDDDDD)V

    return-void
.end method

.method public static i([Lio/nn/lpop/UR$b;Landroid/graphics/Path;)V
    .registers 2

    invoke-static {p0, p1}, Lio/nn/lpop/UR;->j([Lio/nn/lpop/UR$b;Landroid/graphics/Path;)V
...
# virtual methods
.method public h(Lio/nn/lpop/UR$b;Lio/nn/lpop/UR$b;F)V
    .registers 8
    ...
    :goto_5
    iget-object v1, p1, Lio/nn/lpop/UR$b;->b:[F

    array-length v2, v1

    if-ge v0, v2, :cond_1f

    iget-object v2, p0, Lio/nn/lpop/UR$b;->b:[F
    ...
    iget-object v3, p2, Lio/nn/lpop/UR$b;->b:[F
