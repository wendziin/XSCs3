...
.class public abstract Lio/nn/lpop/cd0;
...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Lio/nn/lpop/cd0;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_8
    :try_start_8
    invoke-static {p0, p1, p2}, Lio/nn/lpop/cd0;->c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :cond_12
    :try_start_12
    invoke-static {p0}, Lio/nn/lpop/cd0;->g(Ljava/io/File;)Ljava/nio/ByteBuffer;
...
.method public static c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :try_start_4
    invoke-static {p0, p1}, Lio/nn/lpop/cd0;->d(Ljava/io/File;Ljava/io/InputStream;)Z

    move-result p0
    :try_end_8
    .catchall {:try_start_4 .. :try_end_8} :catchall_c

    invoke-static {p1}, Lio/nn/lpop/cd0;->a(Ljava/io/Closeable;)V
...
.method public static d(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    :cond_20
    invoke-static {v3}, Lio/nn/lpop/cd0;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v2}, Lio/nn/lpop/cd0;->a(Ljava/io/Closeable;)V
...
.method public static h(Landroid/content/Context;[Lio/nn/lpop/ax$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .registers 8
    ...
    invoke-virtual {v3}, Lio/nn/lpop/ax$b;->b()I
    ...
    :cond_12
    invoke-virtual {v3}, Lio/nn/lpop/ax$b;->d()Landroid/net/Uri;
    ...
    :cond_1d
    invoke-static {p0, p2, v3}, Lio/nn/lpop/cd0;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
